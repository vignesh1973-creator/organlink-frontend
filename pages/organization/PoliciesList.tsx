        ...
        <div className="space-y-8">
          ...
          <div className="bg-blue-600 rounded-2xl px-8 py-6 text-white">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              ...
              <Button className="w-full md:w-auto bg-white text-blue-600 hover:bg-blue-50" asChild>
                ...
                <Card key={policy.id} className="border border-gray-200">
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex flex-wrap gap-2 mb-2">
                          <Badge
                            className={`${policy.status === 'active' || policy.status === 'ACTIVE'
                        ...
                        <p className="text-gray-600 text-sm mb-3 line-clamp-2 md:line-clamp-none">{policy.content || policy.description}</p>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      <div className="flex flex-col sm:flex-row sm:items-center text-sm text-gray-600 gap-1 sm:gap-0">
                      ...
                      <div className="flex space-x-2 w-full md:w-auto">
                        {!policy.isMyProposal && policy.status === 'voting' && (
                          policy.hasVoted ? (
                            <Badge className="bg-green-100 text-green-800 hover:bg-green-100 flex-1 md:flex-none justify-center">
                              ✓ Voted {policy.myVote}
                            </Badge>
                          ) : (
                            <Button
                        ...
                        {policy.isMyProposal && policy.totalVotes === 0 && (
                          <Button
                            variant="destructive"
                            size="sm"
                            className="flex items-center space-x-1 flex-1 md:flex-none"
